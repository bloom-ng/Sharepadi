...
<html lang="en">
    ...
    <body>
        ...
        >
            ...
            ></div>
            <div
                class="absolute text-center z-20 md:mx-64 mt-36 md:mt-20 text-black"
            >
                <h1
                    class="text-[20px] mx-10 leading-[24px] md:text-[63px] md:leading-[55px] montserrat-bold"
                >
        ...
        <div class="">
            <div class="pb-32">
                <div
                    class="flex flex-wrap md:flex-cols gap-32 md:gap-20 px-10 md:px-32"
                >
                    <div
                ...
                <div>
                    <div class="rounded-lg">
                        ...
                        <div class="pt-10 text-center px-10">
                            ...
                            <p
                                class="text-[15px] leading-[23px] montserrat-regular"
                            >
            ...
            <div class="pb-10">
                ...
                <div>
                    <div class="rounded-lg">
                        <div class="flex flex-row justify-center">
                            <img
                                class="w-64 -mt-1 z-20 rounded-xl"
            ...
            <div class="pb-2">
                ...
                <div>
                    <div class="rounded-lg">
                        <div class="flex flex-row justify-center">
                            <img
                                class="w-64 -mt-1 z-10 rounded-xl"
        ...
        <div class="px-6 md:px-20">
            <div class="pb-6">
                ...
                >
                    ...
                    <img
                        class="hidden md:block z-20 w-8 h-7"
                        src="/images/sort-up.png"
                        alt=""
                    />
                    <!-- <div
