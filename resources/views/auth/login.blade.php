...
<body>
    ...
    <div class="flex items-center justify-start w-screen h-screen">
        <div
            ...
            <h2 class="montserrat-bold text-[32px] mb-8">Login to Your Account</h2>
            <form method="POST" action="{{ route('login') }}" class="w-full flex flex-col items-center">
                ...
                <div class="text-center mb-4">
                    <p class="text-black font-medium montserrat-regular 14px">Don't have an account? </p>

                </div>
                <a href="{{ route('register') }}"
                    class="bg-[#FFEEE7] text-white px-4 rounded-full w-full text-center font-extrabold max-w-[419px] py-[19px] lg:mb-12">Sign
                    Up</a>
            </form>
        </div>
