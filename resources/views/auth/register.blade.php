...
<head>
    ...
    <title>SharePadi - Register</title>
</head>
...
<body>
    ...
    <div class="flex items-center justify-start w-screen h-screen">
        <div
            class="flex flex-col items-center justify-center h-full basis-full lg:basis-1/2 bg-[#F0F0F0] px-8 lg:px-28">
            <h2 class="montserrat-bold text-[32px] mb-8">Register an Account</h2>
            <form method="POST" action="{{ route('register') }}" class="w-full flex flex-col items-center">
                ...
                <button type="submit"
                    class="bg-[#F48857] text-white px-4 rounded-full w-full text-center font-extrabold max-w-[419px] py-[19px] lg:mb-12">Register</button>

                <div class="text-center mb-4">
                    <p class="text-black font-medium montserrat-regular 14px">Already have an account? </p>

                </div>
                <a href="{{ route('login') }}"
                    class="bg-[#FFEEE7] text-white px-4 rounded-full w-full text-center font-extrabold max-w-[419px] py-[19px] lg:mb-12">Login</a>
            </form>
        </div>
