<div id="dropdown10" class="hidden relative flex flex-row justify-center">
    <div class="flex flex-row justify-center fixed inset-0 z-30 pt-6">
        <div class="absolute inset-0 bg-gray-800 bg-opacity-75"></div>
        <div
            class="flex flex-col items-center hide-scrollbar overflow-auto w-full z-40"
        >
            <div
                ...
                >
                    ...
                    >
                        ...
                        <div class="w-full">
                            ...
                            @error('name')
                            <div
                                class="text-[#F48857] montserrat-thin italic mb-4"
                            >
                                {{ $message }}
                            </div>
                            @enderror
                    ...
                    @error('password')
                    <div class="text-[#F48857] montserrat-thin italic mb-4">
                        {{ $message }}
                    </div>
                    @enderror
                    ...
                    >
                        ...
                        <input
                            type="password"
                            id="mobile_password_confirmation"
                    ...
                    >
                        ...
                        <div class="w-full">
                            <input
                                type="where_did_you_hear"
                                id="mobile_where_did_you_hear"
                    ...
                    <button
                        type="submit"
                        class="bg-[#F48857] text-white px-4 rounded-full w-full text-center font-extrabold max-w-[419px] py-[10px] lg:mb-12"
                    >
                        Register
                    </button>
