<div id="dropdown7" class="absolute hidden mt-4 -ml-[370px] z-30">
    <div class="flex flex-col items-center w-[700px] justify-start">
        ...
        >
            <h2 class="montserrat-bold text-[32px] mb-8">
            ...
            >
                ...
                <button
                    type="submit"
                    class="bg-[#F48857] text-[#F0F0F0] px-4 rounded-full w-full text-center font-extrabold max-w-[419px] py-[19px] lg:mb-12"
                >
                    Login
                </button>

                <div class="text-center mb-4">
                    <p class="text-black font-medium montserrat-regular 14px">
