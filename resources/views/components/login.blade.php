<div id="dropdown7" class="hidden relative flex flex-row justify-center">
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <button
                        type="submit"
                        class="bg-[#F48857] text-[#F0F0F0] px-4 rounded-full w-full text-center font-extrabold max-w-[419px] py-[19px] md:mb-8 lg:mb-12"
                    >
                        Login
                    </button>
