        ...
        <main class="w-full flex-grow py-6 px-6 lg:px-24">
            ...
            <div class="flex flex-col my-12 items-start">
                ...
                <form action="/user/update_profile" method="post" class="flex flex-col gap-6 items-start lg:w-1/2">
                    ...
                    <input type="email" placeholder="Email" name="email"
                        class="italic montserrat-thin rounded-full px-8 py-2 border border-black lg:w-[570px]">
                    <button type="submit" class="text-white rounded-full bg-[#F48857] px-6 py-2 font-semibold">Save
                        Changes</button>
                </form>
            </div>
            ...
            <div class="flex flex-col my-12 items-start">
                ...
                <form action="/user/update_password" method="post" class="flex flex-col gap-6 items-start lg:w-1/2">
                    ...
                    <button type="submit" class="text-white rounded-full bg-[#F48857] px-6 py-2 font-semibold">Change
                        Password</button>
                </form>
            </div>
            ...
            <div class="flex flex-col my-12 items-start">
                ...
                <form action="/user/logout" method="GET" class="flex flex-col gap-6 items-start lg:w-1/2">
                    @csrf
                    <button type="submit"
                        class="rounded-full text-[#F48857] border border-[#F48857] px-12 py-2 font-semibold">Sign
                        Out</button>
                </form>
            </div>
        </main>
