...
<x-admin_dashboard page="tutorials">
    ...
    <a class="text-white rounded-full bg-[#F48857] px-6 py-2 font-semibold" href="/admin/create-tutorial">Create</a>
    <table class="w-full self-start mt-12">
        ...
        <tbody class="pt-12">
            ...
            <tr>
                ...
                <td class="whitespace-wrap text-left"><a class="text-red-500" href="/admin/delete-tutorial/{{ $tutorial->id }}">Delete</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
