            ...
            <div class="flex flex-col my-12 items-start">
                <h2 class="text-3xl text-black pb-6 font-semibold montserrat-bold">Details</h2>
                    <form action="/admin/create-admins" method="post" class="flex flex-col gap-6 items-start lg:w-1/2">
                        ...
                        <input type="text" placeholder="Phone Number" name="phone" class="italic montserrat-thin rounded-full px-8 py-2 border border-black lg:w-[570px]">
                        <input type="password" placeholder="Password" name="password" class="italic montserrat-thin rounded-full px-8 py-2 border border-black lg:w-[570px]">
                        <select name="type" class="italic montserrat-thin rounded-full px-8 py-2 border border-black lg:w-[570px]">
                            <option value="{{App\Models\Admin::SUPER_ADMIN}}">Super Admin</option>
                            <option value="{{App\Models\Admin::ADMIN}}">Admin</option>
                        </select>
                        <button type="submit" class="text-white rounded-full bg-[#F48857] px-16 py-2 font-bold text-xl">Create</button>
                    </form>
            </div>
